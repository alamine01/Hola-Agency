...
const MessageItem = ({ text, time, sent }) => {
            ...
            <div className={`flex-1 flex-col min-w-0 min-h-0 bg-slate-50/10 ${activeConv ? 'flex' : 'hidden lg:flex'}`}>
                {activeConv ? (
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center text-slate-400 p-8 text-center">
                        <MessageSquare className="w-12 h-12 mb-4 opacity-10 text-slate-400" />
...
export default function DynamicMessagesView({ role = 'client' }) {
    return (
