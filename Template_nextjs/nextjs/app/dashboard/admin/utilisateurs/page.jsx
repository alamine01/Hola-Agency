                                        ...
                                        <div className="flex items-center justify-end gap-2">
                                            {updatingId === profile.id ? (
                                                ...
                                                <div className="relative group/menu">
                                                    ...
                                                    <div className="absolute top-full right-0 mt-2 w-48 bg-white border border-slate-100 rounded-2xl shadow-2xl z-50 p-2 hidden group-hover/menu:block animate-in fade-in slide-in-from-top-2 duration-150 after:content-[''] after:absolute after:bottom-full after:left-0 after:right-0 after:h-4">
