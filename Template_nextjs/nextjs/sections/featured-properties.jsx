                    ...
                    {properties.map((property, index) => (
                        <Link href={`/logements/${property.id}`} key={property.id}>
                            <motion.div
                                ...
                                className="group bg-white rounded-3xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-[0_20px_40px_rgb(0,0,0,0.06)] transition-all duration-300 cursor-pointer"
                            >
