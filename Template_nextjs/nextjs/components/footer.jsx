...
export default function Footer() {
    ...
    return (
        <footer className="px-4 md:px-16 lg:px-24 text-[14px] mt-24 pt-16 pb-12 bg-white text-slate-600 border-t border-slate-100">
            <div className="container-hola grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="container-hola mt-20 pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4">
